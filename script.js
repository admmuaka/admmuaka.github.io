...
const i18n = {
  fr: {
    ...
    about_p1: "Data Scientist diplômée d’un Master en Statistiques Appliquées, spécialisée en data science, machine learning et analyse statistique.<br><br> Expérience en Python, SQL, visualisation, modélisation prédictive et traitement de données.<br><br> Compétente dans la conception et l’industrialisation de solutions data sur mesure, en lien étroit avec les besoins métiers.<br><br> Forte appétence pour la résolution de problèmes complexes, la communication interdisciplinaire et les environnements dynamiques et internationaux.<br><br> Intérêt particulier pour l’assurance, la finance , la transformation data & IA et les cas d’usage innovants (modélisation, IA générative, NLP, prévision)",
  ...
  en: {
    ...
    about_p1: "Data Scientist with a Master’s degree in Applied Statistics, specialized in data science, machine learning, and statistical analysis.<br><br>Experienced in Python, SQL, data visualization, predictive modeling, and data processing.<br><br>Skilled in designing and deploying tailored data solutions, closely aligned with business needs.<br><br>Strong ability to solve complex problems, communicate across disciplines, and thrive in dynamic, international environments.<br><br>Particularly interested in insurance, finance, data & AI transformation, and innovative use cases (modeling, generative AI, NLP, forecasting).",
    contact_title: "Contact",
