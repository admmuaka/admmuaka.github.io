...
const i18n = {
  fr: {
    ...
    skills_tools_title: "Technologies & outils que j'utilise",
  ...
  en: {
    ...
    skills_tools_title: "Technologies & tools I use",
    about_title: "About",
    about_sub: "Impact-driven, hands-on statistics profile.",
    about_p1: "Data Scientist with a Master’s degree in Applied Statistics, specialized in data science, machine learning, and statistical analysis.Experienced in Python, SQL, data visualization, predictive modeling, and data processing.Skilled in designing and deploying tailored data solutions, closely aligned with business needs. Strong ability to solve complex problems, communicate across disciplines, and thrive in dynamic, international environments.Particularly interested in insurance, finance, data & AI transformation, and innovative use cases (modeling, generative AI, NLP, forecasting).",
    contact_title: "Contact",
